...
# Job description
job_description = """
Looking for a Software Engineer proficient in Python, JavaScript, and cloud platforms like AWS. 
Should have experience in API development, database systems, and Agile methodologies. 
Knowledge of machine learning or DevOps practices is a plus.
"""

resume_folder = r"C:\Users\KhushiOjha\Downloads\Resume_HR\Resume_HR"  # Replace with your folder path containing PDF resumes
